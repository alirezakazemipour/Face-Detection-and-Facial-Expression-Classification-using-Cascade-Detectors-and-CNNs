...
opencv_traincascade -data lbp -vec samples.vec -bg negatives.txt -numStages 20 -minHitRate 0.999 -maxFalseAlarmRate 0.5 -numPos 3277 -numNeg 3558 -w 40 -h 40 -mode ALL -precalcValBufSize 2048 -precalcIdxBufSize 2048 -featureType LBP
